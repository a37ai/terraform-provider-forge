...
func (p *forgeProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{newContentPolicyResource, newAccessPolicyResource, newResourcePolicyResource, newResourceProxyResource, newResourceGatewayResource, newResourceCredentialResource, newLLMGatewayAccessProfileResource, newLLMGatewayServiceAccountResource, newLLMGatewayManagedAccessOverrideResource, newDeviceGatewayIdentityAssignmentResource, newMCPACLResource, newSkillACLResource, newPolicyAuthorityResource}
}
